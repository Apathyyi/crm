	...
	$(function(){
		...
		$.post("${pageContext.request.contextPath}/baseDict_findByTypeCode.action",{"dict_type_code":"002"},function(data){
			$(data).each(function(i,n){
				...
				$("#cust_source option[value='${model.baseDictsorce.dict_id}']").prop("selected","selected");
			});
		},"json");
		//获取客户行业
...
<BODY>
	<div style="colour:red"><s:fielderror></s:fielderror></div>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								<td>客户名称：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180p" maxlength="50" name="cust_name" value="%{model.cust_name}"/>
								</td>
								<td>信息来源 ：</td>
								<td>
								<select id="cust_source" name="baseDictsorce.dict_id">
							...
							<TR>
								<td>固定电话 ：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180p" maxlength="50" name="cust_phone" value="%{model.cust_phone}"/>
								</td>
								<td>移动电话 ：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180p" maxlength="50" name="cust_mobile" value="%{model.cust_mobile}"/>
								</td >
							</TR>
							<tr>
							<td>公司资质 ：</td>
